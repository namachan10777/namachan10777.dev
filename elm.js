...
var author$project$Main$setSystemTime = A2(
	elm$core$Task$perform,
	...
	return _Utils_Tuple2(
		...
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					author$project$Main$setSystemTime,
					author$project$Storage$requestStoraged(_Utils_Tuple0)
				])));
};
var author$project$Main$LoadStoraged = function (a) {
	return {$: 'LoadStoraged', a: a};
};
...
var author$project$Main$toKeyValue = function (string) {
	...
	if ((_n0.$ === 'Just') && (_n0.a.b === '')) {
		if (' ' === _n0.a.a.valueOf()) {
			var _n1 = _n0.a;
			return author$project$Main$Control('Space');
		} else {
			var _n2 = _n0.a;
			var _char = _n2.a;
...
var author$project$Storage$outputDecoder = A2(
						...
						A3(
							...
							F2(
								function (author, link) {
									return _Utils_Tuple2(author, link);
								}),
							A2(elm$json$Json$Decode$field, 'author', elm$json$Json$Decode$string),
							A2(elm$json$Json$Decode$field, 'link', elm$json$Json$Decode$string))));
			default:
				var other = typeName;
				return elm$json$Json$Decode$fail('unexpected output type: ' + other);
		}
	},
	A2(elm$json$Json$Decode$field, 'type', elm$json$Json$Decode$string));
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Storage$cmdResultDecoder = A2(
	elm$json$Json$Decode$andThen,
	function (typeName) {
		switch (typeName) {
			case 'stdout':
				return A2(
					...
					A2(
						...
						'outputs',
						elm$json$Json$Decode$list(author$project$Storage$outputDecoder)));
			case 'nocmd':
				return elm$json$Json$Decode$succeed(author$project$Os$NoCmd);
			case 'clear':
				return elm$json$Json$Decode$succeed(author$project$Os$Clear);
			default:
				var other = typeName;
				return elm$json$Json$Decode$fail('unexpected cmd result type: ' + other);
		}
	},
	A2(elm$json$Json$Decode$field, 'type', elm$json$Json$Decode$string));
var author$project$Storage$histDecoder = A4(
	elm$json$Json$Decode$map3,
	F3(
		function (dir, cmd, result) {
			return _Utils_Tuple3(dir, cmd, result);
		}),
	...
	A2(elm$json$Json$Decode$field, 'result', author$project$Storage$cmdResultDecoder));
var author$project$Storage$histsDecoder = elm$json$Json$Decode$list(author$project$Storage$histDecoder);
var author$project$Os$System = F2(
	function (root, current) {
		return {current: current, root: root};
	});
function author$project$Storage$cyclic$fsDecoder() {
	return A2(
		elm$json$Json$Decode$andThen,
		function (typeName) {
			switch (typeName) {
					...
					return A3(
						...
						A2(
							...
							elm$json$Json$Decode$list(
								author$project$Storage$cyclic$fsDecoder())));
				default:
					var other = typeName;
					return elm$json$Json$Decode$fail('unexpected fs type: ' + other);
			}
		},
		A2(elm$json$Json$Decode$field, 'type', elm$json$Json$Decode$string));
}
try {
	var author$project$Storage$fsDecoder = author$project$Storage$cyclic$fsDecoder();
	author$project$Storage$cyclic$fsDecoder = function () {
		return author$project$Storage$fsDecoder;
	};
} catch ($) {
throw 'Some top-level definitions from `Storage` are causing infinite recursion:\n\n  ┌─────┐\n  │    fsDecoder\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.0/halting-problem to learn how to fix it!';}
var author$project$Storage$systemDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Os$System,
	A2(elm$json$Json$Decode$field, 'root', author$project$Storage$fsDecoder),
	A2(
		elm$json$Json$Decode$field,
		'current',
		elm$json$Json$Decode$list(elm$json$Json$Decode$string)));
var author$project$Storage$storagedDecoder = A3(
	elm$json$Json$Decode$map2,
	F2(
		function (hists, system) {
			return _Utils_Tuple2(hists, system);
		}),
	A2(elm$json$Json$Decode$field, 'hists', author$project$Storage$histsDecoder),
	A2(elm$json$Json$Decode$field, 'system', author$project$Storage$systemDecoder));
var elm$json$Json$Decode$decodeValue = _Json_run;
var author$project$Storage$loadStoraged = function (f) {
	return author$project$Storage$loadStoragedPort(
		function (value) {
			return f(
				A2(elm$json$Json$Decode$decodeValue, author$project$Storage$storagedDecoder, value));
		});
};
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2(elm$json$Json$Decode$map, author$project$Main$Type, author$project$Main$keyDecoder)),
				A2(elm$time$Time$every, 1000, author$project$Main$SetCurrentTime),
				author$project$Storage$loadStoraged(author$project$Main$LoadStoraged)
			]));
};
...
var author$project$Storage$outputEncode = function (output) {
	switch (output.$) {
		case 'Str':
			var text = output.a;
				...
				return elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'class',
							elm$json$Json$Encode$string(_class)),
							_Utils_Tuple2(
							'src',
				...
				return elm$json$Json$Encode$object(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'author',
							elm$json$Json$Encode$string(author)),
							_Utils_Tuple2(
							'link',
							elm$json$Json$Encode$string(link))
						]));
...
var author$project$Storage$cmdResultEncode = function (cmdResult) {
	switch (cmdResult.$) {
		case 'Stdout':
		...
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'children',
					A2(elm$json$Json$Encode$list, author$project$Storage$fsEncode, children))
				]));
	} else {
		var name = fs.a;
		var id = fs.b;
...
var author$project$Storage$systemEncode = function (system) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'current',
				A2(elm$json$Json$Encode$list, elm$json$Json$Encode$string, system.current)),
				_Utils_Tuple2(
				'root',
				author$project$Storage$fsEncode(system.root))
			]));
};
var author$project$Storage$storagedEncode = function (storaged) {
	var hists = storaged.a;
	var system = storaged.b;
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'hists',
				author$project$Storage$histsEncode(hists)),
				_Utils_Tuple2(
				'system',
				author$project$Storage$systemEncode(system))
			]));
};
var author$project$Storage$storeStoragedPort = _Platform_outgoingPort('storeStoragedPort', elm$core$Basics$identity);
var author$project$Storage$storeStoraged = F2(
	function (system, hists) {
		return author$project$Storage$storeStoragedPort(
			author$project$Storage$storagedEncode(
				_Utils_Tuple2(hists, system)));
	});
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Type':
				if ((msg.a.$ === 'Control') && (msg.a.a === 'Enter')) {
					var inputs = A2(
						elm$core$List$filter,
						function (s) {
							return s !== '';
						},
						A2(elm$core$String$split, ' ', model.current));
					var cmd = A2(
						elm$core$Maybe$withDefault,
						'',
...
var author$project$Main$renderPrompt = function (dir) {
	return A2(
		elm$html$Html$span,
		_List_Nil,
		_List_fromArray(
...
var author$project$Main$renderStdout = function (outputs) {
	return function (elements) {
		return A2(elm$html$Html$div, _List_Nil, elements);
	}(
		A2(
			elm$core$List$map,
			function (output) {
				switch (output.$) {
					case 'Str':
						...
						return A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('stdout')
								]),
							_List_fromArray(
								[
...
var author$project$Main$renderHists = function (model) {
	return A2(
		elm$core$List$map,
		function (hist) {
			if (hist.c.$ === 'Stdout') {
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									author$project$Main$renderPrompt(dir),
									elm$html$Html$text(cmd)
								])),
							author$project$Main$renderStdout(outputs)
						]));
			} else {
				var dir = hist.a;
				var cmd = hist.b;
...
var author$project$Main$renderPowerline = function (model) {
	var zeroPadding = F2(
		function (n, s) {
			return _Utils_ap(
				A2(
					elm$core$String$repeat,
					n - elm$core$String$length(s),
					'0'),
				s);
		});
	var year = elm$core$String$fromInt(
		A2(elm$time$Time$toYear, model.zone, model.posix));
	var second = A2(
		zeroPadding,
		2,
		elm$core$String$fromInt(
			A2(elm$time$Time$toSecond, model.zone, model.posix)));
	var month = author$project$Main$toEnMonth(
		A2(elm$time$Time$toMonth, model.zone, model.posix));
	var minute = A2(
		zeroPadding,
		2,
		elm$core$String$fromInt(
			A2(elm$time$Time$toMinute, model.zone, model.posix)));
	var hour = A2(
		zeroPadding,
		2,
		elm$core$String$fromInt(
			A2(elm$time$Time$toHour, model.zone, model.posix)));
	var day = elm$core$String$fromInt(
		A2(elm$time$Time$toDay, model.zone, model.posix));
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('terminal-info')
					]),
				_List_fromArray(
					[
						elm$html$Html$text('fish- 1:namachan10777*')
					])),
				A2(
				elm$html$Html$span,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(month + (' ' + (day + (' ' + (year + (' ' + (hour + (':' + (minute + (':' + second))))))))))
					]))
			]));
};
				...
				[
					...
					_List_fromArray(
						[
							...
							elm$html$Html$Attributes$value(model.current),
							elm$html$Html$Events$onInput(author$project$Main$Change),
							elm$html$Html$Attributes$autofocus(true)
						]),
					_List_Nil)
				])),
		author$project$Main$renderHists(model));
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('scroll-area')
					]),
				elm$core$List$reverse(lists)),
				author$project$Main$renderPowerline(model)
			]));
};
