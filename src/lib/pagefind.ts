...
export type PagefindCompoundFilter = {
  any?: string | string[] | PagefindSimpleFilter;
  all?: string | string[] | PagefindSimpleFilter;
  not?: string | string[] | PagefindSimpleFilter;
  none?: string | string[] | PagefindSimpleFilter;
};

export type PagefindSimpleFilter = Record<
  string,
  string | string[] | PagefindCompoundFilter
>;

export type PagefindFilter = PagefindSimpleFilter | PagefindCompoundFilter;
...
export type PagefindMergeIndexOptions = {
  indexWeight?: number;
  mergeFilter?: PagefindFilter;
};
...
export type Pagefind = {
  ...
  mergeIndex: (
    indexPath: string,
    options?: PagefindMergeIndexOptions,
  ) => Promise<void>;
  /**
...
export function usePagefind(options?: PagefindIndexOptions): {
  api: NoSerialize<Pagefind> | null;
} {
  const store = useStore<{ api: NoSerialize<Pagefind> | null }>({
    api: null,
  });
